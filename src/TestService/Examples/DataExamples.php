...
class DataExamples
{
    ...
    public function illustrateScaling()
    {
        ...
        //dd($this->matrixDirectionalVarianceGradient($dataMatrix, [0, 1, 2]));
        //dd($this->firstPrincipalComponent($this->getPCAData()));

        //list($user_A, $user_B, $user_C) = $dataMatrix;
        $projection = $this->vectorProject($user_A, $user_B);
        $dataMatrix = [$user_A, $user_B, $user_C];
        //$removeProjection = $this->removeProjection([], $projection);
        //$removeProjection = $this->removeProjectionFromVector($user_A, $projection);
        //dd($user_A, $user_B, $projection, $removeProjection);

        dd($this->principalComponentAnalysis($dataMatrix, 10));
